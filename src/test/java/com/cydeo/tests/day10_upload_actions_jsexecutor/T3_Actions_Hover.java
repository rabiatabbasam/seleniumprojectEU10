...
public class T3_Actions_Hover {
    ...
    public void hovering_test(){
        ...
        WebElement img1 = Driver.getDriver().findElement(By.xpath("(//image)[1]"));
        WebElement img2 = Driver.getDriver().findElement(By.xpath("(//image)[2]"));
        WebElement img3 = Driver.getDriver().findElement(By.xpath("(//image)[3]"));
