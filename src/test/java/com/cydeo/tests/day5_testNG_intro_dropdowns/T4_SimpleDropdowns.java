   ...
   @Test
    public void simpleDropdowntest(){
     ...
     String expectedDropdownText = "Please select an option";
       ...
       Assert.assertEquals(actualSimpleDropdownText, expectedDropdownText);

       //4- Verify "Select selection" default selected value is correct

       Select stataDropdown = new Select(driver.findElement(By.xpath("//select[@id='state']")));

       String expectedStateDropdown = "Select a state";
       String actualStateDropdown = stataDropdown.getFirstSelectedOption().getText();
